...
public class FromJsonTest {
    @Test
    public void empty() {
        BinsonObject obj = BinsonObject.fromJson("{}");
        assertEquals(0, obj.size());
    }
    
    @Test
    public void oneString() {
        BinsonObject obj = BinsonObject.fromJson("{\"a\": \"hi!\"}");
    ...
    public void oneInteger() {
        BinsonObject obj = BinsonObject.fromJson("{\"a\": 1234}");
        assertEquals(1, obj.size());
    ...
    public void nested() {
        String json = "{\"a\":{\"b\":12}}";
        BinsonObject obj = BinsonObject.fromJson(json);
        BinsonObject nested = obj.getObject("a");
    ...
    public void testUEscapeOmega() {
        String s = "{\"omega\": \"\u03a9\"}";
        BinsonObject obj = BinsonObject.fromJson(s);
    ...
    public void testSimpleFraction() {
        BinsonObject obj = BinsonObject.fromJson("{\"a\": 1.2}");
